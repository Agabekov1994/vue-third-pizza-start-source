                ...
                <div class="content__dough">
                    ...
                    <div class="sheet">
                        ...
                        <div class="sheet__content dough">
                            <label v-for="doughItem in dough"
                             class="dough__input"
                             :class="`dough__input--${ doughSize[doughItem.id] }`"
                             :key="doughItem.id">
                                <input type="radio" name="dought" :value="doughSize[doughItem.id]" class="visually-hidden">
                                <b>{{ doughItem.name }}</b>
                ...
                <div class="content__diameter">
                    <div class="sheet">
                        ...
                        <div v-for="size in sizes"
                         ...
                         :key="size.id">
                            <label class="diameter__input" :class="`diameter__input--${sizeValue[size.id]}`">
                                <input type="radio" name="diameter" :value="sizeValue[size.id]" class="visually-hidden">
                                <span>{{ size.name }}</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="sheet">
                        ...
                        <div class="sheet__content ingredients">
                            ...
                            <div class="ingredients__sauce">
                                ...
                                <label v-for="sauce in sauces" 
                                class="radio ingredients__input"
                                :key="sauce.id">
                                    <input type="radio" name="sauce" :value="saucesValue[sauce.id]">
                            ...
                            <div class="ingredients__filling">
                                ...
                                <ul class="ingredients__list">
                                    ...
                                    :key="ingredient.id">
                                        <span class="filling" :class="`filling--${ingredientsValue[ingredient.id]}`">{{ ingredient.name }}</span>
...
import ingredientsValue from "../common/data/ingredients"
import misc from "../mocks/misc.json";
import sauces from "../mocks/sauces.json";
import saucesValue from "../common/data/sauces"
import sizes from "../mocks/sizes.json";
import sizeValue from "../common/data/sizes"
import doughSize from "../common/data/doughSizes"
</script>
